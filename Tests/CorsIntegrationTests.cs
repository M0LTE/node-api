...
public class CorsIntegrationTests : IClassFixture<TestWebApplicationFactory>
{
    ...
    {
        // Arrange
        var request = new HttpRequestMessage(HttpMethod.Get, "/api/history/traces");
    ...
    public async Task API_Should_Handle_Preflight_Request()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Options, "/api/history/traces");
        request.Headers.Add("Origin", "https://example.com");
    ...
    {
        // Arrange
        var request = new HttpRequestMessage(HttpMethod.Get, "/api/history/traces?limit=10");
        request.Headers.Add("Origin", "https://example.com");
    ...
    {
        // Arrange
        var request = new HttpRequestMessage(HttpMethod.Get, "/api/history/events");
        request.Headers.Add("Origin", "https://example.com");
