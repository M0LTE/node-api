...
public readonly record struct XrouterUdpJsonFrame
{
    ...
    public XrouterUdpJsonDigipeater[]? Digipeaters { get; init; }
    ...
    public XrouterUdpJsonNode[]? Nodes { get; init; }

}

public readonly record struct XrouterUdpJsonNode
{
...
public readonly record struct XrouterUdpJsonDigipeater
{
    [JsonPropertyName("call")]
    public required string Callsign { get; init; }
